  ...
  getLiveEngineNodes: function(params) {
    ...
    return this.getAllMembers().then((function(members) {
      ...
      var liveEngineNodes = members.filter(function(member) {
        var nodeType = member.Tags[Tag.nodeType] || '';
        var nodeRole = member.Tags[Tag.nodeRole] || '';
        if (nodeType.toLowerCase() != NodeType.ENGINE ||
            nodeRole.toLowerCase() != NodeRole.SERVICE_PROVIDER)
          return false;
